...
def confirm_booking():
    ...
    # return str(create_calendar_event(start_date))
    # form = UserCarSearchForm()
    # return render_template("/customer/car_view.html", cars=[], form=form, start_date="", end_date="")
...
def create_calendar_event(start_date):
    ...
    return calendar.setupCalendar()
    return calendar.addToCalendar( "ahjhj24012000@gmail.com", "2020-09-03","2020-09-04","car id")
